...
import net.lycan.mccourse.block.entity.GemEmpoweringStationBlockEntity;
...
public class GemEmpoweringScreenHandler extends ScreenHandler {
    ...
    @Override
    public ItemStack quickMove(PlayerEntity player, int invSlot) {  ItemStack newStack = ItemStack.EMPTY;
