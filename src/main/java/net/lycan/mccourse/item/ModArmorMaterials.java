...
public enum ModArmorMaterials implements ArmorMaterial {
                ...
                }), 24, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 1.0f, 0f, () -> Ingredient.ofItems(ModItems.PINK_GARNET));
    ...
    private ModArmorMaterials(String name, int durabilityMultiplier, EnumMap<ArmorItem.Type, Integer > protectionAmounts,
        int enchantability, SoundEvent equipSound,float toughness, float knockbackResistance, Supplier<
