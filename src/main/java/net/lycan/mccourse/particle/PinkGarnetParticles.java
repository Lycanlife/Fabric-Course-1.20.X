...
public class PinkGarnetParticles extends SpriteBillboardParticle {
    public PinkGarnetParticles(ClientWorld world, double xCoord, double yCoord, double zCoord,
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        return new PinkGarnetParticles(clientWorld, x, y, z, this.sprites, xd, yd, zd);
        }
    }
}
