package net.lycan.mccourse.sound;
...
public class ModSounds {
    ...
    public static final BlockSoundGroup PINK_GARNET_LAMP_SOUNDS = new BlockSoundGroup(1f,1f,
            PINK_GARNET_LAMP_BREAK, PINK_GARNET_LAMP_FALL, PINK_GARNET_LAMP_PLACE, PINK_GARNET_LAMP_HIT, PINK_GARNET_LAMP_STEP);
    ...
    public static void registerSounds(){
        MCCourseMod.LOGGER.info("Registering Sounds for " + MCCourseMod.MOD_ID);
    }
}
